...
int main()
{
    ...
    students[0] = (Student){"Alice", 101, "123 Main Street", "9876543210", 90};
    ...
    while(action != 7)
    {
        switch(action)
        {
            ...
            printf("Please enter the Student's Roll Number: ");
            scanf(" %d" , &rollno);
            findMarks(students, rollno, size);
            break;
            ...
            printf("0. Exit\n");
            int choice;
            printf("Which Student whould you like to delete: ");
            scanf(" %d" , &choice);
            if (choice == 0)
            {
            ...
            int student;
            printf("What Student's data would you like to update: ");
            scanf(" %d" , &student);
            if (student > size)
            {
                break;
